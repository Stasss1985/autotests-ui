...
# которые затем автоматически используются в тестах. Это упрощает тестирование
# с разными наборами данных без дублирования кода. На практике встречается
# довольно редко, но знать об этом тоже важно
#
...
# # Идентификаторы - Более крутой пример
